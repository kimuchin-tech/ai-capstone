"""
재정경제부장관 명의 국회 질의 공식 답변 초안 작성 (Streamlit)
...
DRAFT_SYSTEM = """당신은 대한민국 기획재정부(재정경제부) 장관 명의 국회 서면·구두 답변 초안을 작성하는 필기관입니다.
...
def run_draft(
    ...
    human = (
        ...
        "=== 끝 ===\n\n"
        "위 질의서 전문과 식별자에 맞추어 장관 명의 답변 초안 전문을 작성하십시오. "
...
def main() -> None:
    ...
    st.subheader("1. 재정경제부장관 명의 답변 초안")
    st.markdown(draft)
